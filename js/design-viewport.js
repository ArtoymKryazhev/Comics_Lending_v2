/**
 * EXAMPLE — скопировано из Kutukov_business_landing как рабочий образец adaptive.
 * Менять / переписывать только с одобрения пользователя.
 *
 * Фактическое поведение: desktop при innerWidth >= 1024, иначе mobile.
 * Gate: vw < 320 → unsupported. Mobile ready при наличии .page-index.
 */
(function () {
